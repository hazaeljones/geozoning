...
```{r,echo=TRUE,message=FALSE, warning=FALSE}
  ...
  dispZ(map$step,matVal=map$krigGrid,zonePolygone=Z,boundary=map$boundary)
...
m3=best[4:6]
m4=best[7:10]
# build best zonings for a given number of labels (between 2 and 4), that implies calculating corrections for the best zonings determined in the exploration loop
