---
title: "View zoning with zone distribution"
...
```{r,echo=TRUE,message=FALSE, warning=FALSE}
   # Generate zoning Z from map and quantile vector with small zone correction
   # small zones are kept until the end so that they get more chance to grow.
