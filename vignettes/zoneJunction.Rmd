...
```{r,echo=TRUE,message=FALSE, warning=FALSE}
   ...
   Z=K$zonePolygone
   plotZ(Z)
   printLabZ(list(K)) # zones 9 to 12 have the same label(0)
   # join zone 11 with another zone near by (zone 12)- both zones have the same label
   kmi=optiRG(K,map,11,12,disp=1)
