...
Or a more detailed plot - compare it to previous plot of contour lines
...
Junction of 2 zones: Join zone 9 with another zone near by (zone 10)- both zones have the same label
```{r,echo=TRUE,message=FALSE, warning=FALSE}
