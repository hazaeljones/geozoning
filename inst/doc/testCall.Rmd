...
A map object is simulated with a Gaussian field. 450 points are randomly allocated on a square field of size 1.Then points are kriged using inverse distance weighted interpolation.
