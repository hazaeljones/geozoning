...
#' @param new_Window boolean, if TRUE plot the map in a new graphic device (X11()).
...
plotM = function(map, Z=NULL, lab=NULL, byLab = TRUE, new_Window = TRUE,
