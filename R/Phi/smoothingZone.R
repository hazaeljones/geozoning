...
#' doesn't work properly, please choose another value of the parameter width.

#' @param z zone to be modified (SpatialPolygon)
#' @param widthExt smoothing parameter in gBuffer if dilatation is followed by erosion
#' @param widthInt smoothing parameter in gBuffer if erosion is followed by dilatation
