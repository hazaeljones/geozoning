...
randKmapGrid=function(DataObj,seed=NULL,nPointsK=200,nSimuCond=0,typeMod="Gau",Vpsill=5,Vrange=0.2,
                      Vmean=8,Vang=0,Vanis=1,alphavario=NULL,boundary=list(x=c(0,0,1,1,0),y=c(0,1,1,0,0)),
...
##########################################################
 ...
 # or simulates them if DataObj=NULL
      resGene=genData(DataObj,seed,nPoints,typeMod,Vpsill,Vrange,Vmean,Vang,Vanis,alphavario,boundary,manualBoundary)
